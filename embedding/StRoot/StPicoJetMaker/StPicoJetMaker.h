...
{
  public:
  //    StPicoJetMaker(char const* name, StPicoDstMaker* picoMaker, char const* outputBaseFileName);
  StPicoJetMaker(char const* name, StPicoDstMaker* picoMaker, char const* outputBaseFileName,  
		 char const* inputHFListHFtree);  //Jana
...
inline void StPicoJetMaker::setTreeName(const char* tName)  { mOutputTreeName = tName; }
