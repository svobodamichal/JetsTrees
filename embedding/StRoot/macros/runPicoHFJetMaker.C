...
//void runPicoHFJetMaker(const Char_t *inputFile, const Char_t *outputFile="outputBaseName",  
//			const unsigned int makerMode = 0 /*kAnalyze*/,
//			const Char_t *badRunListFileName="BadRunList_14.list", const Char_t *hotTowerListFileName="HotTowerList_14.list", const Char_t *treeName = "picoDst") {


    /*string SL_version = "pro"; //new: SL16d -> SL16j -> SL18h for run14
     string env_SL = getenv ("STAR_LEVEL");
...
//starprod AuAu 2014 luminosity - split low mid high, without lumi = early runs
//
//
...
*/
    ...
    vector<float> R; R.push_back(0.2); R.push_back(0.3); R.push_back(0.4);
//vector<float> R;R.push_back(0.2); R.push_back(0.4);

    vector<float> Acuts; Acuts.push_back(0.07); Acuts.push_back(0.2); Acuts.push_back(0.4);
//vector<float> Acuts;Acuts.push_back(0.07); Acuts.push_back(0.4);

    vector<float> EmbPt; EmbPt.push_back(3.0); EmbPt.push_back(5.0); EmbPt.push_back(7.0); EmbPt.push_back(10.0); EmbPt.push_back(20.0);
//vector<float> EmbPt;  EmbPt.push_back(5.0); EmbPt.push_back(20.0);
...
//USE gRefMultCorr or RefMultCorr??
    ...
    //StRefMultCorr* grefmultCorrUtil = CentralityMaker::instance()->getgRefMultCorr_P18ih(); //new StRefMultCorr, info about Run16, SL16d in the same file as for Run14, SL16d

    StRefMultCorr* grefmultCorrUtil = CentralityMaker::instance()->getRefMultCorr_P18ih_VpdMB30_MidLow(); //new StRefMultCorr, info about Run14
    stPicoHFJetMaker->setRefMultCorr(grefmultCorrUtil);

    //StRefMultCorr* refmultCorrUtil = CentralityMaker::instance()->getgRefMultCorr_VpdMB30(); //new StRefMultCorr, info about Run14
